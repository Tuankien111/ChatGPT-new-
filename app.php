...
if (!isset($_SESSION['username']) || (isset($_SESSION['last_activity']) && (time() - $_SESSION['last_activity']) > 1800) || isset($_SESSION['outdate'])) {
    // Destroy the current session
    session_destroy();

    // Redirect to the login page
    header("Location: login_page/ltr/login.php");
    exit();
}
...
<div class="title-bar" style="display:none">
  ...
  <p>Hello: <?php echo $username . '   Account Type: ' . $account_type . '    End Date: ' . $end_date; ?></p>
    ...
    <ul class="horizontal mobile-menu-toogle menu float-right">
      ...
      <li class="menu-buttons" id="logout"><a href="login_page/ltr/api/api_logout.php" onclick="logOut()"><img src="img/icon-close.svg"> <span>Log out</span></a></li>
    </ul>
  </div>
</div>

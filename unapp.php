...
<div class="title-bar" style="display:none">
  ...
  <p> <?php if (isset($_GET['message'])) {
    ...
    <ul class="horizontal mobile-menu-toogle menu float-right">
      ...
      <li class="menu-buttons" id="logout"><a href="api_logout.php" onclick="logOut()"><img src="img/icon-close.svg"> <span>Log out</span></a></li>
    </ul>
  </div>
</div>
...
<!--                  <input type="text" id="uname" name="name" />-->
                ...
                <button class="submit" tabindex="0"><span>Send</span></button>
